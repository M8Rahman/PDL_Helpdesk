...
<h2>Welcome, <?= htmlspecialchars($_SESSION["username"]) ?> <a href="../auth/logout.php">Logout</a></h2> 
...
<div id="userFilterBox" style="display:none; margin-top:10px;">
    <form id="userFilterForm" onsubmit="event.preventDefault(); loadUserTickets();">
        Ticket No:
